    ...
    try {
      ...
      if (data) {
        setFormData({
          ...
          price: data.selling_price ? data.selling_price.toString() : "",
          originalPrice: data.original_mrp ? data.original_mrp.toString() : "",
          cost: data.cost_price ? data.cost_price.toString() : "",
